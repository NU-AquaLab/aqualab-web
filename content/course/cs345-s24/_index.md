...
- Quick links: [Canvas](https://canvas.northwestern.edu/courses/211330) | [Piazza](https://piazza.com/northwestern/spring2024/nucs345)
...
[Caleb Wang](https://calebwang.info/about) 
Seely Mudd 
[caleb.wang@..](http://aqualab.cs.northwestern.edu/)
...
**TA/Resitation Sessions:** TBD

**Take-home Final:**Due Thursday June 6, 2024 at 11:59PM CST
...
- We will use [Piazza](https://piazza.com/northwestern/spring2024/nucs345) for class discussion. TAs and I will check Piazza frequently and answer unresolved questions, but you’re also encouraged to collaborate with each other and answer each other’s questions.
- There is always email for questions that would be inappropriate to post on the newsgroup/discussion board. **When using email to contact the staff please start your subject line with "CS345: <helpful-comment>" to ensure a prompt response (do replace "helpful-comment" by an actual helpful comment, of course :) ).**
