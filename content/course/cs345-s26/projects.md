...
The emphasis of these components shifts over the semester:
...
Correctness in this class is not defined solely by passing tests. It is defined by whether your protocol is well-reasoned, your implementation reflects that reasoning, and your measurements demonstrate understanding of system behavior.
...
The goal is not to produce polished research plots. The goal is to connect:
